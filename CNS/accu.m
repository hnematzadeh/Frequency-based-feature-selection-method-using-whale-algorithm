...
% data=colon6(:,1:6);
% L=colon6(:,7);
% % mysvm=svmtrain(data(1:50,:),L(1:50),'kernel_function','rbf','boxconstraint',8,'rbf_sigma',1);
% mysvm=svmtrain(data(1:50,:),L(1:50),'kernel_function','rbf','boxconstraint',2,'rbf_sigma',1);
% out=svmclassify(mysvm,data(51:62,:));
% out=sum(out==L(51:62))/12;
% out
for i=1 :100
load('test8.mat');
data=test8;
